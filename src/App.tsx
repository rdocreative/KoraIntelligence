...
const ProtectedRoute = () => {
  ...
  if (loading) {
    return <div className="h-screen w-full flex items-center justify-center bg-[#0d111a]"><div className="w-8 h-8 border-4 border-[#22d3ee] border-t-transparent rounded-full animate-spin"></div></div>;
  }
          ...
          <HabitProvider>
            <MasterplanProvider>
              <TooltipProvider>
                <Sonner theme="dark" />
                <BrowserRouter>
                  <div className="min-h-screen text-[#f0f0f2] font-sans flex flex-col relative overflow-x-hidden bg-[#0d111a]">
                    <Routes>
                      {/* Rotas Públicas */}
