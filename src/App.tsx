...
const ProtectedRoute = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#0A0C10] flex items-center justify-center overflow-hidden">
      <div className="flex h-full w-full max-w-[1600px] mx-auto text-white antialiased bg-transparent overflow-hidden border-none outline-none ring-0 p-[10px]">
        <SideNav />
        <div 
