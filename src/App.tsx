...
const ProtectedRoute = () => {
  ...
  if (loading) {
    return <div className="h-screen w-full flex items-center justify-center bg-background"><div className="w-10 h-10 border-4 border-primary border-t-transparent rounded-full animate-spin"></div></div>;
  }
          ...
          <HabitProvider>
            <MasterplanProvider>
              <TooltipProvider>
                ...
                <Sonner theme="dark" />
                <BrowserRouter>
                  <div className="min-h-screen text-text font-sans selection:bg-primary selection:text-background">
                    <Routes>
                      {/* Rotas Públicas */}
