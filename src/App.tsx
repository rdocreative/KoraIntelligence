...
const ProtectedRoute = () => {
  ...
  return (
    <div 
      className="flex h-screen w-full text-white antialiased overflow-hidden border-none outline-none ring-0"
      style={{ 
    ...
    >
      ...
      <div className="flex-1 flex flex-col p-4 pl-0 min-w-0 bg-transparent">
        <div 
          className="flex-1 flex flex-col rounded-[24px] overflow-hidden relative min-h-0 w-full border-none outline-none shadow-none ring-0 bg-transparent"
        >
