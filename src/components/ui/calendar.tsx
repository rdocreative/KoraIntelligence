    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-neutral-300 hover:text-white hover:bg-white/10"
        ),
        ...
        day_outside:
          "day-outside text-neutral-700 opacity-50 aria-selected:bg-white/5 aria-selected:text-neutral-500 aria-selected:opacity-30",
