...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-4 bg-[#0F0F0F] border border-white/10 rounded-2xl shadow-2xl", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-white/10 text-white hover:bg-white/10 transition-all rounded-lg"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-neutral-500 rounded-md w-9 font-bold text-[0.7rem] uppercase tracking-wider",
