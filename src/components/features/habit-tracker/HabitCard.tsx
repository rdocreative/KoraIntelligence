  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        {/* Icon Container */}
        <div className={cn(
          "h-12 w-12 rounded-full flex items-center justify-center border-2 shadow-inner bg-gradient-to-br from-[#202020] to-[#101010] shrink-0",
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            ...
            {!isForToday && (
              <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-neutral-800 text-neutral-500 border border-white/5 uppercase tracking-wider">
                Fora da Escala
              </span>
            )}
          </div>
          ...
          {habit.description && (
            <p className="text-xs text-neutral-500 line-clamp-1 mb-2 font-medium">
              {habit.description}
            </p>
          )}

          <div className="flex items-center gap-3 text-[10px] font-bold text-neutral-600 uppercase tracking-tighter">
            <div className="flex gap-1">
              {DAY_NAMES.map((day, i) => (
                <span 
                  ...
                  className={cn(
                    "px-1 rounded-sm",
                    habit.days.includes(i) ? "text-red-500/70" : "text-neutral-800"
                  )}
                >
                  {day}
                </span>
            ...
            className={cn(
              ...
              habit.completed 
                ...
                : isForToday 
                  ...
                  : "bg-neutral-800 text-neutral-600 border-none cursor-not-allowed"
            )}
          >
