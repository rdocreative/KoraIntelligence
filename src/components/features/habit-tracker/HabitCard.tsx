  ...
  return (
    <div 
      className={cn(
        ...
        "bg-[#0a0a0c] border-white/5 hover:border-red-600/30",
    ...
    >
      ...
      <div className="flex items-center gap-4 relative z-10">
        <div className={cn(
          ...
          index < 3 ? "text-red-700 drop-shadow-[0_0_10px_rgba(220,38,38,0.3)]" : "text-white/5"
        )}>
          {index + 1}
        </div>
        ...
        <div className={cn(
          ...
          habit.completed 
            ...
            : "bg-black border-white/5 group-hover:border-red-600/40 group-hover:bg-red-600/5"
        )}>
          {habit.completed ? (
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-[10px] font-bold text-white/20 uppercase tracking-widest">
            ...
            <span className="font-rajdhani text-sm text-red-600 font-bold opacity-80">{habit.points} XP</span>
          </div>
        </div>
        ...
        <div className="shrink-0">
          <Button
            ...
            className={cn(
              ...
              habit.completed 
                ? "bg-green-600/5 text-green-500/50 border border-green-500/10" 
                : isForToday 
                  ? "bg-red-800 hover:bg-red-700 text-white shadow-xl shadow-black/50" 
