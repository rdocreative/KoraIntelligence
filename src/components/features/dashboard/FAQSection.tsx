...
export const FAQSection = () => {
  return (
    <Card className="bg-white/[0.05] border border-[#222230] rounded-2xl shadow-none backdrop-blur-md">
      <CardHeader className="pb-2 border-b border-white/[0.05]">
      ...
      <CardContent className="pt-4">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2" className="border-white/[0.05]">
            <AccordionTrigger className="text-[#f0f0f2] font-bold hover:no-underline hover:text-red-400">
          ...
          <AccordionItem value="item-3" className="border-white/[0.05]">
            <AccordionTrigger className="text-[#f0f0f2] font-bold hover:no-underline hover:text-red-400">
