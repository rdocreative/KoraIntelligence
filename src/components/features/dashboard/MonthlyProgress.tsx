    ...
    <Card className="bg-white/[0.02] border border-white/20 rounded-2xl shadow-xl backdrop-blur-3xl overflow-hidden">
      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat, i) => (
            <div key={i} className="group flex flex-col justify-between p-4 rounded-xl bg-white/[0.01] border border-white/10 hover:bg-white/[0.04] transition-all cursor-default">
