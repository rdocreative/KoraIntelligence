...
export const MonthlyProgress = ({ totalPoints, habitsCount }: MonthlyProgressProps) => {
  ...
  return (
    <Card className="card-glass border-white/5 overflow-hidden">
      ...
      <CardContent className="space-y-8 pt-8">
        <div className="space-y-2">
          ...
          <div className="h-2 w-full bg-black/60 rounded-full overflow-hidden border border-white/5">
            <div 
                className="h-full bg-gradient-to-r from-red-900 to-red-600 shadow-[0_0_15px_rgba(239,68,68,0.3)] transition-all duration-1000"
