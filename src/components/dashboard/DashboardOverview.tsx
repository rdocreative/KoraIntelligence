...
const DATA_DISTRIBUTION = [
  { name: 'Saúde', value: 400, color: '#FF784F' },
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 w-full max-w-6xl mx-auto px-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "TOTAL HÁBITOS", value: displayStats.total, icon: Target, color: "#FF784F", shadow: "#C94E28" },
      ...
      <div className="bg-[var(--panel)] border-2 border-[var(--border-ui)] rounded-[40px] p-10 shadow-[var(--shadow-ui)] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
          <div className="relative">
            <div className="w-28 h-28 rounded-full border-[6px] border-[#FF784F] flex items-center justify-center bg-[var(--background)] shadow-xl">
              <span className="text-[36px] font-[950] text-[#FF784F]">12</span>
            </div>
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-[#FF784F] text-white text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-tighter shadow-lg">
              NÍVEL
            </div>
          </div>
          ...
          <div className="flex-1 w-full space-y-6">
            <div className="flex justify-between items-end">
              ...
              <div className="text-right">
                <span className="text-[#FF784F] font-black text-xl">2.450 / 3.000</span>
            ...
            <div className="h-5 w-full bg-[var(--border-ui)] rounded-full overflow-hidden p-1 shadow-inner">
              <div 
                className="h-full bg-gradient-to-r from-[#FF784F] to-[#C94E28] rounded-full transition-all duration-1000" 
                style={{ width: '75%' }}
              />
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex items-center gap-2.5 bg-[var(--card)] px-4 py-2 rounded-2xl border-2 border-[var(--border-ui)] shadow-sm">
                <Zap size={16} className="text-[#FF784F] fill-[#FF784F]" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-[var(--panel)] border-2 border-[var(--border-ui)] rounded-[32px] p-8 shadow-[var(--shadow-ui)]">
          <div className="flex items-center gap-3 mb-10">
            <div className="p-2.5 bg-[#FF784F]/10 rounded-xl text-[#FF784F]">
              <TrendingUp size={20} />
            </div>
              ...
              <AreaChart data={DATA_EVOLUTION}>
                <defs>
                  <linearGradient id="colorHabit" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#FF784F" stopOpacity={0.4}/>
                    <stop offset="95%" stopColor="#FF784F" stopOpacity={0}/>
                  </linearGradient>
                </defs>
