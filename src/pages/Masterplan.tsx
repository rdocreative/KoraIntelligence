        ...
        <Tabs defaultValue="overview" className="w-full space-y-8">
          ...
          <TabsContent value="annual" className="space-y-10 outline-none animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                  <div className="space-y-8">
                      <div className="space-y-3">
                          <Label className="text-red-500 font-black tracking-[0.2em] uppercase text-xs">Objetivo Principal do Ano</Label>
                          <Input 
                              value={data.annual.objective}
                              onChange={(e) => updateAnnual({ objective: e.target.value })}
                              className="text-3xl md:text-4xl font-black bg-transparent border-none border-b border-white/10 rounded-none focus-visible:ring-0 px-0 h-auto py-4 placeholder:text-neutral-800 text-white transition-all focus:border-red-500"
                          />
                      </div>

                      <div className="space-y-3">
                          <Label className="text-neutral-500 font-bold uppercase tracking-[0.2em] text-xs">Critério de Sucesso</Label>
                          <Textarea 
                              value={data.annual.successCriteria}
                              onChange={(e) => updateAnnual({ successCriteria: e.target.value })}
                              className="bg-[#0A0A0A] border-white/10 resize-none h-32 text-base transition-all focus:ring-1 focus:ring-red-500/20 p-4"
                          />
                      </div>

                      <div className="space-y-6 pt-6 border-t border-white/5">
                          <div className="flex justify-between items-end">
                              <Label className="text-neutral-500 font-bold uppercase tracking-[0.2em] text-xs">Progresso Anual Manual</Label>
                  ...
                  <div className="grid gap-6">
                      <Card className="bg-[#0A0A0A] border-white/5">
                          <CardHeader className="pb-2"><CardTitle className="text-xs uppercase tracking-[0.2em] font-bold text-blue-500">Trabalho & Dinheiro</CardTitle></CardHeader>
                      ...
                      <Card className="bg-[#0A0A0A] border-white/5">
                          <CardHeader className="pb-2"><CardTitle className="text-xs uppercase tracking-[0.2em] font-bold text-purple-500">Estudos</CardTitle></CardHeader>
                      ...
                      <Card className="bg-[#0A0A0A] border-white/5">
                          <CardHeader className="pb-2"><CardTitle className="text-xs uppercase tracking-[0.2em] font-bold text-red-500">Saúde</CardTitle></CardHeader>
                      ...
                      <Card className="bg-[#0A0A0A] border-white/5">
                          <CardHeader className="pb-2"><CardTitle className="text-xs uppercase tracking-[0.2em] font-bold text-yellow-500">Pessoal</CardTitle></CardHeader>
