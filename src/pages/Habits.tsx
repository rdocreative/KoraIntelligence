                          ...
                          <Tooltip key={i}>
                            <TooltipTrigger asChild>
                              <div onClick={() => setSelectedDate(day.date)} className={cn(
                                ...
                                day.isCurrentMonth && (day.isPast || day.isToday) && day.level === 1 && "bg-[#FF3B30]/30 border-[#FF3B30] text-[#FF3B30]", 
                                day.isCurrentMonth && (day.isPast || day.isToday) && day.level === 2 && "bg-[#FF9500]/40 border-[#FF9500] text-[#FF9500]", 
                                day.isCurrentMonth && (day.isPast || day.isToday) && day.level === 3 && "bg-[#FFD60A]/50 border-[#FFD60A] text-[#FFD60A]", 
                                day.isCurrentMonth && (day.isPast || day.isToday) && day.level === 4 && "bg-[#34C759] border-[#34C759] text-white font-black shadow-[0_0_15px_rgba(52,199,89,0.3)]", 
