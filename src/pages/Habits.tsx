...
const HabitsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-4 animate-in fade-in duration-500 relative flex-1 min-w-0">
      ...
      {/* Seletor de Abas Totalmente Fixo (Fixed) */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md flex justify-center px-4 md:px-8 py-6 shrink-0">
      ...
      {/* Conteúdo com margem superior para não ficar sob o seletor fixo */}
