...
const SortableHabitItem = ({ habit, isCompleted, onEdit, onToggle }: SortableItemProps) => {
  ...
  // Correction: Improved design for active habit cards
  ...
  return (
    <div 
      ...
      {...listeners}
      className={cn(
        "group rounded-[16px] border-2 p-[14px] px-[16px] mb-2.5 cursor-grab active:cursor-grabbing select-none transition-transform duration-150 ease-out hover:scale-[1.02]",
        isDragging 
      ...
      <div className="flex items-center gap-[14px]">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-[3px]">
            <div className="flex items-center gap-1 text-[12px] font-[500] text-[#9ca3af] opacity-100">
              <Clock size={12} className="text-[#9ca3af] opacity-100" />
              {habit.time}
            </div>
          </div>
        </div>
        ...
        {!isCompleted && (
          <button 
            ...
            onPointerDown={(e) => e.stopPropagation()}
            className="p-1 text-[#9ca3af] hover:text-[#22d3ee] transition-colors z-10 ml-auto opacity-100"
          >
  ...
  return (
    <div className="min-h-screen bg-transparent pb-10 animate-in fade-in duration-500 relative">
      ...
      <div className="flex justify-center pt-6 pb-2">
        <div className="bg-[#202f36] border-2 border-[#374151] rounded-full p-1 inline-flex gap-1 shadow-[0_4px_0_0_#0b1116] overflow-visible">
          <button
            onClick={() => setActiveTab('overview')}
            className={cn(
              "px-5 py-2 rounded-full text-[12px] font-[800] uppercase tracking-[0.05em] transition-all duration-300 border-none whitespace-nowrap",
              activeTab === 'overview'
        ...
        <div className={cn("w-full transition-all duration-500", viewMode === 'weekly' ? 'lg:w-full' : 'lg:w-[65%]')}>
          ...
          <div className="bg-[#202f36] border-2 border-[#374151] rounded-[24px] py-[20px] px-[24px] shadow-[0_4px_0_0_#0b1116]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              ...
              {/* View Mode Switcher */}
              <div className="bg-[#202f36] border-2 border-[#374151] rounded-full p-1 inline-flex gap-1 shadow-[0_4px_0_0_#0b1116] shrink-0">
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      "flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-[800] uppercase tracking-wider transition-all border-none whitespace-nowrap shrink-0",
                      viewMode === mode.id 
                        ? "bg-[#22d3ee] text-[#111b21] shadow-[0_4px_0_0_#06b6d4]" 
                        : "bg-transparent text-[#9ca3af] hover:text-white"
                    )}
              ...
              <div className="pt-4 mt-2">
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                  <DialogTrigger asChild>
                    <Button className="w-full bg-[#22d3ee] hover:bg-[#22d3ee] active:translate-y-[2px] active:shadow-none transition-all duration-150 text-[#111b21] font-[800] text-[11px] uppercase tracking-[0.1em] h-12 rounded-[16px] shadow-[0_4px_0_0_#06b6d4] border-none">
